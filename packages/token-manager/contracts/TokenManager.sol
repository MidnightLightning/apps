...
contract TokenManager is ITokenController, IForwarder, AragonApp {
    ...
    * @param _token Token address for the managed token (Token Manager instance must be already set as the token controller)
    ...
    */
    ...
    /**
    * @notice Called when ether is sent to the Token contract
    ...
    */
    function proxyPayment(address) public payable returns (bool) {
        ...
        // Token is not instrumented and entire tx is reverted
