...
```
solc @aragon=$(pwd)/node_modules/@aragon --abi contracts/Hamburger.sol -o build --allow-paths=/home/carl/Projects
abigen --abi=./build/Hamburger.abi --pkg=hamburger --out=Hamburger.go
solc @aragon=$(pwd)/node_modules/@aragon --bin contracts/Hamburger.sol -o build --allow-paths=/home/carl/Projects
abigen --bin=./build/Hamburger.bin --abi=./build/Hamburger.abi --pkg=hamburger --out=Hamburger.go
```
